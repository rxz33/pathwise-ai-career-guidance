...
async def cross_exam(user_data: dict):
    """
    Input: user data including resume insights, personal info, preferences.
    Output: 5-6 personalized cross-exam questions.
    """
    analysis = orchestrator.run_cross_exam_agent(user_data)
    return analysis
